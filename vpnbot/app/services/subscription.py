    ...
    if user.remnawave_uuid:
        ...
        if remna_user:
            ...
            if sub_url:
                ...
                logger.warning("Remnawave user updated but subscription_url is empty: %s (check inbounds config)", user.remnawave_uuid)
        else:
        ...
        if remna_user:
            ...
            if sub_url:
                ...
                logger.warning("Remnawave user created but subscription_url is empty: TG_%d → %s (check inbounds config)", telegram_id, remna_user.uuid)
        else:
